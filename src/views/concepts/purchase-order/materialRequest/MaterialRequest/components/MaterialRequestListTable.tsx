    ...
    return (
        <div className="flex items-center">
            ...
            <Link
                ...
                to={`/concepts/material-request/material-request-details/${row.id}`}
            >
                {row.name}
            </Link>
        </div>
...
const MaterialRequestListTable = () => {
    ...
    const handleEdit = (customer: Customer) => {
        navigate(`/concepts/purchase-order/material-request/edit/${customer.id}`)
    }

    const handleViewDetails = (customer: Customer) => {
        navigate(`/concepts/purchase-order/material-request/details/${customer.id}`)
    }
