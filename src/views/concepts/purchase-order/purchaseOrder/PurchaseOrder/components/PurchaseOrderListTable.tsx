    ...
    return (
        <div className="flex items-center">
            ...
            <Link
                ...
                to={`/concepts/purchase-order/purchase-order-details/${row.id}`}
            >
                {row.name}
            </Link>
        </div>
...
const PurchaseOrderListTable = () => {
    ...
    const handleEdit = (customer: Customer) => {
        navigate(`/concepts/purchase-order/purchase-order/edit/${customer.id}`)
    }

    const handleViewDetails = (customer: Customer) => {
        navigate(`/concepts/purchase-order/purchase-order/details/${customer.id}`)
    }
