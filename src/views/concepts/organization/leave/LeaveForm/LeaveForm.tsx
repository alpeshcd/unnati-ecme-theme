...
const validationSchema: ZodType = z.object({
    ...
    is_carry_forward: z
        .string()
        .min(1, { message: 'is_carry_forward required' }),
    is_entitlement_situational: z
        .string()
        .min(1, { message: 'is_entitlement_situational required' }),
})

const LeaveForm = (props: CustomerFormProps) => {
    const {
        onFormSubmit,
        defaultValues = {},
        newCustomer = false,
