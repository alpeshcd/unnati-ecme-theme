...
import type { CustomerFormSchema } from '../DepartmentForm'
import type { Customer } from '../DepartmentList/types'
...
const DepartmentEdit = () => {
    ...
    const handleFormSubmit = async (values: CustomerFormSchema) => {
        ...
        navigate('/concepts/organization/department/department-list')
    }
