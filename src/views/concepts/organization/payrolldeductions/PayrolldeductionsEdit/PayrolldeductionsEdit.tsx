...
import type { CustomerFormSchema } from '../PayrolldeductionsForm'
import type { Customer } from '../PayrolldeductionsList/types'
import PayrolldeductionsForm from '../PayrolldeductionsForm'

const PayrolldeductionsEdit = () => {
    const { id } = useParams()
    ...
    const handleFormSubmit = async (values: CustomerFormSchema) => {
        ...
        navigate('/concepts/organization/payroll-deductions/payroll-deductions-list')
    }
