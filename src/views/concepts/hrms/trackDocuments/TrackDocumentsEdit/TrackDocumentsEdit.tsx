...
import TrackDocumentsForm, { CustomerFormSchema } from '../TrackDocumentsForm'


const TrackDocumentsEdit = () => {
    const { id } = useParams()
    ...
    const handleFormSubmit = async (values: CustomerFormSchema) => {
        ...
        navigate('/concepts/hrms/track-documents/track-documents-list')
    }
