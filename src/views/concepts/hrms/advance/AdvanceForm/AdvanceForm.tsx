...
const validationSchema: ZodType = z.object({
    lending_amount: z.string().min(1, { message: 'First name required' }),
    amount_pending: z.string().min(1, { message: 'Last name required' }),
   
})

const AdvanceForm = (props: CustomerFormProps) => {
    const {
        onFormSubmit,
        defaultValues = {},
        newCustomer = false,
