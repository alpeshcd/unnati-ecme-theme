...
import AttendanceVerificationForm, { CustomerFormSchema } from '../AttendanceVerificationForm'


const AttendanceVerificationEdit = () => {
    const { id } = useParams()
    ...
    const handleFormSubmit = async (values: CustomerFormSchema) => {
        ...
        navigate('/concepts/hrms/attendance-verification/attendance-verification-list')
    }
