...
import PayrollRecordForm, { CustomerFormSchema } from '../PayrollRecordForm'


const PayrollRecordEdit = () => {
    const { id } = useParams()
    ...
    const handleFormSubmit = async (values: CustomerFormSchema) => {
        ...
        navigate('/concepts/hrms/payroll/payroll-list')
    }
    ...
    const handleConfirmDelete = () => {
        ...
        navigate('/concepts/hrms/payroll-record/payroll-record-list')
    }
...
export default PayrollRecordEdit
