    ...
    return (
        <div className="flex items-center">
            ...
            <Link
                ...
                to={`/concepts/items/items-details/${row.id}`}
            >
                {row.name}
            </Link>
        </div>
...
const ItemsListTable = () => {
    ...
    const handleEdit = (customer: Customer) => {
        navigate(`/concepts/stock-management/items/edit/${customer.id}`)
    }

    const handleViewDetails = (customer: Customer) => {
        navigate(`/concepts/stock-management/items/details/${customer.id}`)
    }
