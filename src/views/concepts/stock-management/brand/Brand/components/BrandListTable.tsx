    ...
    return (
        <div className="flex items-center">
            ...
            <Link
                ...
                to={`/concepts/brand/brand-details/${row.id}`}
            >
                {row.name}
            </Link>
        </div>
...
const BrandListTable = () => {
    ...
    const handleEdit = (customer: Customer) => {
        navigate(`/concepts/stock-management/brand/edit/${customer.id}`)
    }

    const handleViewDetails = (customer: Customer) => {
        navigate(`/concepts/stock-management/brand/details/${customer.id}`)
    }
