    ...
    return (
        <div className="flex items-center">
            ...
            <Link
                ...
                to={`/concepts/vendor/vendor-details/${row.id}`}
            >
                {row.name}
            </Link>
        </div>
...
const VendorListTable = () => {
    ...
    const handleEdit = (customer: Customer) => {
        navigate(`/concepts/stock-management/vendor/edit/${customer.id}`)
    }

    const handleViewDetails = (customer: Customer) => {
        navigate(`/concepts/stock-management/vendor/details/${customer.id}`)
    }
