...
import ItemPricingForm, { CustomerFormSchema } from '../ItemPricingForm'


const ItemPricingEdit = () => {
    const { id } = useParams()
    ...
    const handleFormSubmit = async (values: CustomerFormSchema) => {
        ...
        navigate('/concepts/stock-management/item-pricing/item-pricing-list')
    }
...
export default ItemPricingEdit
