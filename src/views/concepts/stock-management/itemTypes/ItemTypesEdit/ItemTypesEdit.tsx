...
import ItemsTypesForm, { CustomerFormSchema } from '../ItemTypesForm'
...
const ItemTypesEdit = () => {
    ...
    const handleFormSubmit = async (values: CustomerFormSchema) => {
        ...
        navigate('/concepts/stock-management/items-types/items-types-list')
    }
